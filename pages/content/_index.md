...
<div class="not-prose flex justify-center my-8">
  <a href="icelandic_holidays.ics"
     class="flex flex-col items-center gap-3 p-8 rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 hover:bg-primary-50 dark:hover:bg-primary-900 hover:border-primary-400 dark:hover:border-primary-500 transition-all duration-200 group no-underline"
     download="icelandic_holidays.ics"
